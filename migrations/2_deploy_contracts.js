...
module.exports = function(deployer, network, accounts) {
    ...
    // Deploy the BallotManager contract and pass the chairperson address
    deployer.deploy(BallotManager, chairpersonAddress).then(async (ballotManagerInstance) => {
        ...
        console.log("Deployed Ballot contract address:", ballotAddress);
